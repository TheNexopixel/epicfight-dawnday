...
public class MiladyCollider {
    ...
    public static final Collider HALBERD = registerCollider(ResourceLocation.fromNamespaceAndPath(Epicfight_dd.MODID,"halbeard"),new MultiOBBCollider(6, 0.4D, 0.8D, 1D, 0D, 0.0D, -1.8D));
