...
public class WingStanceAnims {
    ...
    public static AnimationManager.AnimationAccessor<StaticAnimation> WINGSTANCE_IDLE;
    public static AnimationManager.AnimationAccessor<StaticAnimation> WINGSTANCE_WALK;
    ...
    public static void build(AnimationManager.AnimationBuilder builder){
        ...
        WINGSTANCE_IDLE = builder.nextAccessor("biped/skill/wingstance/wingstance_idle",
