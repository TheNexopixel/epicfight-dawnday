...
public class TremedeousRetaliationSkill extends WeaponInnateSkill {

    private static final float STAMINA_COST = 2.0F;


    public TremedeousRetaliationSkill(SkillBuilder<? extends WeaponInnateSkill> builder) {
        super(builder);
    }
    ...
    public void executeOnServer(SkillContainer container, FriendlyByteBuf args) {
      ...
      //  PlayerPatch<?> player = container.getServerExecutor();
        ...
        container.getExecutor().playAnimationSynchronized(DawnDayAnimations.TREMENDOUS_RETALIATION,0.0f);
    }
}
