...
public class DawnDayCollider {
    ...
    public static final Collider EVIL_TACHI_COUNTER = registerCollider(ResourceLocation.fromNamespaceAndPath(Epicfight_dd.MODID,"evil_tachi_counter"),new MultiOBBCollider(1, 2.0D, 0.8D, 1.5D, -0.5D, 1.0D, -1.3D));
    ...
    public static final Collider SHIELD = registerCollider(ResourceLocation.fromNamespaceAndPath(Epicfight_dd.MODID,"shield"),new MultiOBBCollider(2, 0.15D, 0.55D, 0.75D, 0.0D, 0.15D, -0.35D));
