...
public class DawnDayCollider {
    ...
    public static final Collider BATTLESTAFF_FULL = registerCollider(ResourceLocation.fromNamespaceAndPath(Epicfight_dd.MODID,"battlestaff_full"),new MultiOBBCollider(6, 0.3D, 0.4D, 2.55D, 0D, 0.0D, 0.0D));
    ...
    public static final Collider HOOKCLAWS_SPECIAL = registerCollider(ResourceLocation.fromNamespaceAndPath(Epicfight_dd.MODID,"hookclaws_auto4"),new MultiOBBCollider(1, 1.2D, 1.0D, 1.5D, 0D, 1.5D, -1.2D));
    ...
    public static final Collider BEAST_EYE = registerCollider(ResourceLocation.fromNamespaceAndPath(Epicfight_dd.MODID,"beast_eye"),new MultiOBBCollider(1, 1.8D, 1.0D, 7.1D, 0D, 1.5D, 6.6D));
    ...
    public static final Collider IUDEX_HALBERD = registerCollider(ResourceLocation.fromNamespaceAndPath(Epicfight_dd.MODID,"iudex_halberd"),new MultiOBBCollider(4, 0.3D, 0.450D, 2.1D, 0D, 0.0D, -2.0D));
