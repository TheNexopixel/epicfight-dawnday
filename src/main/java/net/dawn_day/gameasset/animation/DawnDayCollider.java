...
public class DawnDayCollider {
    ...
    public static final Collider WAR_SICKLE = registerCollider(ResourceLocation.fromNamespaceAndPath(EpicFightDawnDay.MOD_ID,"war_sickle"),new MultiOBBCollider(6, 0.5D, 0.5D, 1.0D, 0D, 0.0D, -2.0D));
    ...
    public static final Collider BATTLESTAFF_BACK = registerCollider(ResourceLocation.fromNamespaceAndPath(EpicFightDawnDay.MOD_ID,"battlestaff_back"),new MultiOBBCollider(4, 0.3D, 0.4D, -1.3D, 0D, 0.0D, 1.0D));
    ...
    public static final Collider EVIL_TACHI = registerCollider(ResourceLocation.fromNamespaceAndPath(EpicFightDawnDay.MOD_ID,"evil_tachi"),new MultiOBBCollider(3, 0.3D, 0.3D, 1.6D, 0D, 0.0D, -1.6D));
    public static final Collider EVIL_TACHI_BACK = registerCollider(ResourceLocation.fromNamespaceAndPath(EpicFightDawnDay.MOD_ID,"evil_tachi_back"),new MultiOBBCollider(3, 0.35D, 0.35D, 0.6D, 0D, 0.0D, 0.7D));
    public static final Collider EVIL_TACHI_SPECIAL = registerCollider(ResourceLocation.fromNamespaceAndPath(EpicFightDawnDay.MOD_ID,"evil_tachi_special"),new MultiOBBCollider(2, 0.55D, 0.65D, 0.6D, 0D, 0.3D, 0.45D));
    public static final Collider EVIL_TACHI_COUNTER = registerCollider(ResourceLocation.fromNamespaceAndPath(EpicFightDawnDay.MOD_ID,"evil_tachi_counter"),new MultiOBBCollider(1, 2.0D, 0.8D, 1.5D, -0.5D, 1.0D, -1.3D));
    public static final Collider EVIL_TACHI_RAY = registerCollider(ResourceLocation.fromNamespaceAndPath(EpicFightDawnDay.MOD_ID,"evil_tachi_ray"),new MultiOBBCollider(1, 0.4D, 0.4D, 10.5D, 0D, 1.0D, -11.4D));
