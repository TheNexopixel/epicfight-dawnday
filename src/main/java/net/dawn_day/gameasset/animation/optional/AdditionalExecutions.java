    ...
    public static void build(AnimationManager.AnimationBuilder builder) {
       MultiCollider<OBBCollider> evil_collider = new MultiOBBCollider(1, 2.0F, 7.5F, 9.5F, 0.0F, 3.5F, 1.5F);
        ...
        EVIL_TACHI_EXECUTE = builder.nextAccessor("biped/execution/evil_odachi_execute", (accessor)->
                evil_execution(accessor,evil_collider,CONSTANT_EXECUTION)
...
//                                            WOMParticles.BLACK_RAY, worldX, worldY, worldZ,
...
//                                    );
    ...
    )
    {
        return (new ExecutionAttackAnimation(0.01F, accessor,
                ...
                Armatures.BIPED, new ExecutionAttackAnimation.ExecutionPhase[]{(new ExecutionAttackAnimation.ExecutionPhase(false, 0.0F, 0.0F, (float) 0.4, (float) 0.41, 12.73F, 1.23F, Armatures.BIPED.get().rootJoint, executionCollider))
                ...
                (new ExecutionAttackAnimation.ExecutionPhase(true, 1.23F, 0.0F, (float) 3.02, (float) 3.05, 18.0F, 20.0F, Armatures.BIPED.get().rootJoint, executionCollider))
