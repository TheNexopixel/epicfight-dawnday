...
public class WingStanceAnims {
    ...
    public static AnimationManager.AnimationAccessor<ComboAttackAnimation> WINGSTANCE_ATTACK_1;
    public static AnimationManager.AnimationAccessor<ComboAttackAnimation> WINGSTANCE_ATTACK_2;
    public static AnimationManager.AnimationAccessor<ComboAttackAnimation> WINGSTANCE_ATTACK_3;
    public static AnimationManager.AnimationAccessor<ComboAttackAnimation> WINGSTANCE_CROUCH_ATTACK;
    public static AnimationManager.AnimationAccessor<ComboAttackAnimation> WINGSTANCE_ATTACK_5;
    public static AnimationManager.AnimationAccessor<DashAttackAnimation> WINGSTANCE_DASH;
    public static AnimationManager.AnimationAccessor<ComboAttackAnimation> WINGSTANCE_AIRSLASH;
    ...
    public static void build(AnimationManager.AnimationBuilder builder){
        ...
        WINGSTANCE_SKILL1 = builder.nextAccessor("biped/skill/wingstance/wingstance_skill1", (accessor) ->
                new AttackAnimation(0.12F, accessor, biped,
                        ...
                        new AttackAnimation.Phase(0.81f, 0.87f, 1.10f, 1.4f, 2.0f,1.41f, InteractionHand.MAIN_HAND, biped.get().toolR,null)
                                ...
                                .addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, EpicFightSounds.BLADE_RUSH_FINISHER.value()),
        ...
        WINGSTANCE_SKILL2 = builder.nextAccessor("biped/skill/wingstance/wingstance_skill2", (accessor) ->
                new AttackAnimation(0.12F, 0.6F, 0.65F, 1.12F, 1.8F, null, biped.get().toolR, accessor, biped)
                        .addProperty(AnimationProperty.AttackPhaseProperty.SWING_SOUND, DawnDaySounds.PIERCING_FANG.value())
                        ...
                        .addProperty(AnimationProperty.ActionAnimationProperty.NO_GRAVITY_TIME, TimePairList.create(0.1F,1.1F))
                        .addProperty(AnimationProperty.AttackAnimationProperty.FIXED_MOVE_DISTANCE,true)
                        .addProperty(AnimationProperty.ActionAnimationProperty.CANCELABLE_MOVE, false));
        ...
        WINGSTANCE_ATTACK_1 = builder.nextAccessor("biped/skill/wingstance/wingstance_auto1", (accessor) ->
                new ComboAttackAnimation(0.12F, 0.0f, 0.7f, 0.9f, 1.0F, null, biped.get().toolR, accessor, biped)
        ...
        WINGSTANCE_ATTACK_2 = builder.nextAccessor("biped/skill/wingstance/wingstance_auto2", (accessor) ->
                new ComboAttackAnimation(0.12F, 0.0f, 0.6f, 0.9f, 1.0F, null, biped.get().toolR, accessor, biped)
                        .addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.4F)
        ...
        WINGSTANCE_CROUCH_ATTACK = builder.nextAccessor("biped/skill/wingstance/wingstance_crouch_attack", (accessor) ->
                new ComboAttackAnimation(0.12F, accessor, biped,
                        new AttackAnimation.Phase(0.0f, 0.05f, 0.18f, 0.30f, 1.4f, 0.38f, InteractionHand.MAIN_HAND, biped.get().legR, ColliderPreset.HEAD)
        ...
        WINGSTANCE_AIRSLASH = builder.nextAccessor("biped/skill/wingstance/wingstance_airslash", (accessor) ->
                new ComboAttackAnimation(0.12F, 0.2f, 0.23f, 0.58f, 0.8F, null, biped.get().toolR, accessor, biped)
                        .addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER,ValueModifier.multiplier( 1.30f))
                        .addProperty(AnimationProperty.AttackPhaseProperty.IMPACT_MODIFIER,ValueModifier.adder( 5))
                        .addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.4F)
                        .addProperty(AnimationProperty.ActionAnimationProperty.CANCELABLE_MOVE, true));
